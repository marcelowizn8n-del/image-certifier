...
function getNextUrl(): string {
  ...
  return url.searchParams.get("next") || "/analyze";
}
...
export default function Auth() {
  ...
  const onLogin = async () => {
    ...
    try {
      ...
      toast.error(t("auth.loginFailed"), { description: e?.message || "Erro" });
    } finally {
      setLoading(false);
    }
  };
  ...
  const onRegister = async () => {
    ...
    try {
      ...
      toast.error(t("auth.registerFailed"), { description: e?.message || "Erro" });
    } finally {
      setLoading(false);
    }
  };
